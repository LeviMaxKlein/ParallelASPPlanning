...
ALGORITHM = ["sequential", "forall", "exists", "guess_and_check", "exists_edge", "relaxed"]
TIME_LIMIT = 1800
MEMORY_LIMIT = 32600
ATTRIBUTES = [
    "error",
...
for algo in ALGORITHM:
    for task in suites.build_suite(BENCHMARKS_DIR, ["zenotravel"]):
        ...
        run.add_command("validate_plan", ["Validate", "-v", task.domain_file, task.problem_file, f"{TMPDIR}/sas_plan"])
